...
@patch('sauceclient.requests.request')
class TestSauce(unittest.TestCase):
    ...
    def test_bad_request(self, mocked):
        ...
        mocked.return_value.status_code = requests.codes.bad
    ...
    #def test_jobs_download_asset(self):
    #    resp = self.sc.jobs.download_asset('job-id', 'filename', 'download_path')
    #    self.assertIsInstance(resp, str)
